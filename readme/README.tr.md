...
İş akışınıza uygun platformu seçin:
...
- **Mobil uygulamalar:** https://github.com/markdown-viewer/docs/blob/main/platforms/mobile.md

Tarayıcıda yerel dosyalar için uzantı ayarlarında dosya URL erişimini etkinleştirin.

## Platformlar

Kurulum, özellikler, platformlar ve gizlilik hakkında daha fazla bilgi:
...
Sorunlar ve öneriler için GitHub kullanın.
