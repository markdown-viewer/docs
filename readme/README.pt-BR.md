...
**Markdown para Word perfeito com um clique — PlantUML, Mermaid, Vega, Canvas, infográfico, Graphviz, LaTeX (editável), destaque de código, processamento local**
...
- ✅ Diagramas Canvas → Imagens em alta definição
- ✅ Gráficos Infographic → Imagens em alta definição
...
**Canvas:** Mapas mentais, quadros de planejamento, grafos de conhecimento → Brainstorming, mapeamento de conceitos  
**Infographic:** Gráficos estatísticos, infográficos, visualização de dados → Apresentação de dados, narrativa visual  
**Graphviz DOT:** Grafos dirigidos/não dirigidos, árvores de dependência → Arquitetura de sistemas, análise de dependências
...
Títulos · Parágrafos · Negrito · Itálico · Tachado · Listas · Listas de tarefas · Citações · Blocos de código (destaque de 100+ linguagens) · Tabelas · Links · Imagens · Diagramas Mermaid · Gráficos Vega / Vega-Lite · Diagramas drawio · Diagramas Canvas · Gráficos Infographic · Grafos Graphviz DOT · Fórmulas LaTeX · HTML · Extensões GFM
...
**Você obterá:** Conversão Markdown → Word com um clique · 6 tipos de diagramas (Mermaid / Vega / drawio / Canvas / Infographic / Graphviz) · Fórmulas LaTeX editáveis · Destaque de código 100+ linguagens · 29+ temas · Cache inteligente · Totalmente gratuito
