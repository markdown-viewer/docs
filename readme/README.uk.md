...
**Markdown у ідеальний Word одним кліком — Mermaid, Vega, drawio, Canvas, інфографіка, Graphviz, LaTeX (редагований), підсвітка коду, локальна обробка**
...
**Mermaid** · **Vega/Vega-Lite** · **drawio** · **Canvas** · **Infographic** · **Graphviz DOT** · SVG-зображення · Складні HTML-таблиці
...
A: Усі діаграми Mermaid (блок-схема, послідовність, Gantt, клас, стан, кругова, ER тощо), діаграми візуалізації даних Vega / Vega-Lite, діаграми drawio, діаграми JSON Canvas, статистичні діаграми Infographic, графи Graphviz DOT + автоконвертація SVG.
