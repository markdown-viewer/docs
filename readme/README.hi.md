...
अपने workflow के हिसाब से platform चुनें:
...
Browser में local files खोलने के लिए extension settings में file URL access enable करें।

## प्लेटफ़ॉर्म

Installation, features, platforms और privacy के बारे में और पढ़ें:
...
Issues और feature requests के लिए GitHub इस्तेमाल करें।
