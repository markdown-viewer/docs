...
Choisissez la plateforme adaptée à votre flux de travail :
...
- **Applications mobiles:** https://github.com/markdown-viewer/docs/blob/main/platforms/mobile.md

Pour les fichiers locaux dans le navigateur, activez l’accès aux URL de fichiers dans les paramètres de l’extension.

## Plateformes

En savoir plus sur l’installation, les fonctions, les plateformes et la confidentialité :
...
Utilisez GitHub pour les problèmes et les demandes de fonctionnalités.
