...
พรีวิว Markdown พร้อมไดอะแกรม สูตร ธีม และส่งออก DOCX/PDF/HTML/EPUB แบบประมวลผลในเครื่อง
...
- ส่งออก PDF และ HTML/EPUB แบบไฟล์เดี่ยวเมื่อแพลตฟอร์มรองรับ
...
เนื้อหาที่รองรับรวมถึง Markdown มาตรฐาน ตารางและรายการงานแบบ GitHub รูปภาพ โค้ดที่ไฮไลต์ สูตรคณิตศาสตร์ เนื้อหา SVG ตาราง HTML ที่ซับซ้อน และไดอะแกรมหรือกราฟที่เขียนด้วยรูปแบบข้อความทั่วไป เช่น PlantUML, Mermaid, Vega/Vega-Lite, drawio, Canvas, Infographic, ECharts และ Graphviz
