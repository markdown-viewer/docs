...
Гэты праект з'яўляецца адкрытым зыходным кодам па ліцэнзіі GPLv3. Запрашаем ставіць Star, паведамляць аб праблемах, прапаноўваць функцыі і ўносіць уклад у код.
