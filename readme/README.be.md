...
**Markdown у ідэальны Word адным клікам — Mermaid, Vega, drawio, Canvas, інфаграфіка, Graphviz, LaTeX (рэдагуемы), падсветка кода, лакальная апрацоўка**
...
**Mermaid** · **Vega/Vega-Lite** · **drawio** · **Canvas** · **Infographic** · **Graphviz DOT** · Выявы SVG · Складаныя табліцы HTML
...
А: Усе дыяграмы Mermaid (блок-схема, паслядоўнасць, gantt, клас, стан, круг, ER і г.д.), дыяграмы візуалізацыі даных Vega / Vega-Lite, дыяграмы drawio, дыяграмы JSON Canvas, статыстычныя дыяграмы Infographic, графы Graphviz DOT + аўтаматычная канверсія SVG.
