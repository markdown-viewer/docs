...
Vali platvorm, mis sobib sinu töövooga:
...
- **Mobiilirakendused:** https://github.com/markdown-viewer/docs/blob/main/platforms/mobile.md

Kohalike failide jaoks brauseris luba laienduse seadetes faili-URL-i juurdepääs.

## Platvormid

Lisateave paigalduse, funktsioonide, platvormide ja privaatsuse kohta:
...
Probleemide ja ettepanekute jaoks kasuta GitHubi.
