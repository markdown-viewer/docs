...
Privacy hoort bij de workflow: normale preview en export worden lokaal in de extensie verwerkt. Je Markdown-bestanden hoeven niet naar een externe renderingdienst te worden geüpload.

## Installatie

Kies het platform dat past bij je workflow:
...
- **Mobiele apps:** https://github.com/markdown-viewer/docs/blob/main/platforms/mobile.md

Schakel voor lokale bestanden in de browser toegang tot bestands-URL’s in bij de extensie-instellingen.

## Platformen

Meer over installatie, functies, platformen en privacy:
...
Gebruik GitHub voor problemen en verzoeken.
