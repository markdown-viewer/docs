...
Rozszerzenie lokalnie renderuje wybrane przez użytkownika pliki Markdown i oferuje eksport dokumentów. Dostęp do adresów URL plików jest potrzebny tylko przy otwieraniu lokalnych plików w przeglądarce. Opis zawiera jedną uporządkowaną listę funkcji.

## Store-Specific Notes

- Chrome Web Store: użyć wspólnego tekstu powyżej.
- Microsoft Edge Add-ons: użyć wspólnego tekstu powyżej.
